...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xbbbbbbff, 0x111111ff, 0x444444ff },
	[SchemeSel]  = { 0xeeeeeeff, 0x111111ff, 0x111111ff },
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_N,          spawn,          SHCMD ("chromium --incognito")},
	{ WLR_MODIFIER_ALT,	     XKB_KEY_b,          spawn,          SHCMD ("firefox")},
	{ WLR_MODIFIER_ALT,          XKB_KEY_n,          spawn,          SHCMD ("firefox --private-window")},
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_P,          spawn,          SHCMD ("slurp | grim -g - - | tee ~/Pictures/$(date +%s).png | wl-copy")},
	{ MODKEY, 		     XKB_KEY_e,          spawn,          SHCMD ("nemo")},
	{ 0,                         XF86AudioLowerVolume, spawn,        SHCMD ("alacritty -e alsamixer")},
	{ 0,                         XF86Launch4,	 spawn,          SHCMD ("~/dotfiles/dwl2/asus-perf.sh")},
